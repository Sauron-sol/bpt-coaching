...
const privatePlans: PrivatePlan[] = [
  ...
  },
  {
    ...
    description:
      "Accompagnement exclusif à Monaco. Flexibilité horaire, cadre haut de gamme et coaching adapté à une clientèle exigeante.",
    travel: "Créneau prioritaire sur Monaco",
    highlights: ["Format haut de gamme", "Flexibilité renforcée", "Accompagnement exclusif"],
    icon: Crown,
    dark: true,
  },
];
